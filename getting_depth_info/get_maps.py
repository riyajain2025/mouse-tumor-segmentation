...
# Function to read all bin files in a folder
...
# Function to save contour plots using original filenames
...
data_array = read_all_bins('./getting_depth_info/bin_files')
save_contours(data_array, './getting_depth_info/data/')